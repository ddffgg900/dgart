...
function(c) {
  ...
  return {
    ...
    onOk: function() {
      ...
      if (this._.selectedElement) this._.selectedElement.data("cke-realelement") ? (a = d(c, a), a.replace(this._.selectedElement), CKEDITOR.env.ie && c.getSelection().selectElement(a)) : this._.selectedElement.setAttributes(a);
      else {
    ...
    onShow: function() {
      ...
      if (e) {
        ...
        this.setValueOf("info", "txtName", f || ""); ! d && a.selectElement(e);
